...
using AzureOauth.Module.Security;
using AzureOauth.Web.Security;
...
namespace AzureOauth.Web {
    ...
    public partial class AzureOauthAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private AzureOauth.Module.AzureOauthModule module3;
        private AzureOauth.Module.Web.AzureOauthAspNetModule module4;
        ...
        private void AzureOauthAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new AzureOauth.Module.AzureOauthModule();
            this.module4 = new AzureOauth.Module.Web.AzureOauthAspNetModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(AzureOauth.Module.BusinessObjects.ApplicationUser);
            // 
            // securityModule1
            // 
            this.securityModule1.UserType = typeof(AzureOauth.Module.BusinessObjects.ApplicationUser);
            // 
            ...
            this.authenticationStandard1.UserLoginInfoType = typeof(AzureOauth.Module.BusinessObjects.ApplicationUserLoginInfo);
            //
            // validationModule
            //
            this.validationModule.AllowValidationDetailsAccess = false;
            // 
            // AzureOauthAspNetApplication
            // 
            this.ApplicationName = "AzureOauth";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.AzureOauthAspNetApplication_DatabaseVersionMismatch);
